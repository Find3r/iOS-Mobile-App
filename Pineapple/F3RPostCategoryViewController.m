//
//  F3RPostCategoryViewController.m
//  Pineapple
//
...
@interface F3RPostCategoryViewController ()
{
...
@implementation F3RPostCategoryViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void) loadData
{
    ...
    NSDictionary *parameters = @{ @"iduser": F3RFacebookUser.user.id, @"idcategory" : _idCategory };
    
    [client invokeAPI:@"news_category_aux"
                 body:nil
           HTTPMethod:@"GET"
